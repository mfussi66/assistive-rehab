...
Datasets used to train an L\+S\+TM for the action recognition pipeline used in the upper limbs demo can be found \href{https://github.com/robotology/assistive-rehab-storage}{\texttt{ here}}. 